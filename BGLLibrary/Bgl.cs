...
public class Bgl
{
    ...
    List<QMID> SubSectionsQMIDs = new();
    ...
    public void AddLibraryObject(LibraryObject Object) {
        ...
        this.SubSectionsQMIDs.Add(new Bgl.QMID(u,v,l));
    ...
    public void BuildBGLFile() {
        ...
        foreach (SceneryObjectSection sec in this.Sections) {
            ...
            else 
            {
                ...
                List<QMID> headerQMIDs = new List<QMID>();
                ...
                do {
                    List<QMID> tmpQMIDs = new List<QMID>(headerQMIDs);
                        ...
                        if (qmid.L < 9) 
                        {
                            ...
                            for (int i=0; i<2; i++) {
                                for (int j=0; j<2; j++) {
                                    ...
                                    bool localMatchQMID (QMID subqmid, List<QMID> existingQmids ) {
                ...
                foreach (QMID qmid in headerQMIDs) 
                {
                    this.Header.QMIDs[w++] = Util.GetQMIDDWORDs(qmid.U, qmid.V, (int)qmid.L);
